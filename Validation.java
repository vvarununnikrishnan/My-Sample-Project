...
public class Validation
{
	...
	private static HashSet<Integer> numberSet = new HashSet<Integer>();
	public static int read_roll(Scanner input, String input_message, HashSet<Student> students)// , ArrayList<Student> students
	{
		int number = -1;   
		while(number < 0)
		{
			...
			{
				number = Integer.valueOf(num);
				boolean result = numberSet.add(number);
				if(!result)
				{	
...
//	private static int read_roll_redundancy_check(int in, HashSet<Student> students)
//	{
